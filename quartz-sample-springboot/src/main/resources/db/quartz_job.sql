...
INSERT INTO `quartz_job` (`id`, `job_name`, `job_group`, `job_cron`, `job_class_path`, `job_data_map`, `job_status`, `job_describe`) VALUES (22, 'test', 'test', '*/20 * * * * ?', 'com.gupaoedu.demo.task.TestTask1', NULL, 1, 'a job a');
INSERT INTO `quartz_job` (`id`, `job_name`, `job_group`, `job_cron`, `job_class_path`, `job_data_map`, `job_status`, `job_describe`) VALUES (23, 'test2', 'test', '*/30 * * * * ?', 'com.gupaoedu.demo.task.TestTask2', NULL, 1, 'another job');
